...
class Game(object):
    ...
    def __init__(self, name="Snake Revamped", size=(640, 480), hiscore=0):
        self.name = name
        self.size = size
        if(hiscore == None): #If you want to start with no high score
            self.hiscore = 0
        else:
    ...
    def main(self):
        '''start a game'''
        self.window.fill(self.settings['backgroundColor']) #'erase' everything
    ...
    def playGame(self):
        ...
        while not self.snake.dead:
            ...
            if(self.settings['backgroundColor'] != self.colors['black']): #for dark mode
            ...
            self.drawBounds() #no bounds in dark mode
            pygame.display.update()
        self.showGameOver()
    ...
    def showOptionsMenu(self):
        ...
        buttons = [backgroundwhitebutton, backgroundredbutton, backgroundgreenbutton, backgroundbluebutton, backgroundblackbutton, snakewhitebutton, snakeredbutton, snakegreenbutton, snakebluebutton, snakeblackbutton, foodwhitebutton, foodredbutton, foodgreenbutton, foodbluebutton, foodblackbutton, donebutton]
        for x in buttons:
            x.create_button()
        while True:
            for event in pygame.event.get():
    ...
    def showGameOver(self):
        ...
        while True:
            ...
            if(self.settings['backgroundColor'] != self.colors['black']): #for dark mode
                ...
                self.window.blit(pygame.font.Font(None, 25).render("Press <ENTER> to Restart, Press <ESCAPE> for Main Menu", False, self.colors['black']), (35, 285))
            else:
                ...
                self.window.blit(pygame.font.Font(None, 25).render("Press <ENTER> to Restart, Press <ESCAPE> for Main Menu", False, self.colors['white']), (35, 285))
            self.drawBounds()
            pygame.display.update()
